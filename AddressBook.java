...
public class AddressBook {
    ...
    private static HashMap<String, AddressBook> addressbook_map = new HashMap<String, AddressBook>();
    private static final String filepath = "D:\\Target 2 (CapGemini)\\BridgeLabz Training\\DataFileIO\\AddressBookData\\data.txt";
    private static final String filepath_csv = "D:\\Target 2 (CapGemini)\\BridgeLabz Training\\DataFileIO\\AddressBookData\\book.csv";
    private static final String filepath_json = "D:\\Target 2 (CapGemini)\\BridgeLabz Training\\DataFileIO\\AddressBookData\\addressbook.json";
    ...
    public HashMap<String,AddressBook> getAddressbook_map(){
        return addressbook_map;
    }

    public Contact findContact(String fname, String lname) {
        Contact find_con = null;
        for(Map.Entry entry : addressbook_map.entrySet()) {
            for(Contact ab : ((AddressBook)entry.getValue()).contacts) {
    ...
    public static List<Contact> findBook(String name){
        ...
        for(Map.Entry<String, AddressBook> entry: addressbook_map.entrySet()) {
    ...
    public void deleteContact(String fname, String lname) {
        ...
        for(Map.Entry entry : addressbook_map.entrySet()) {
            contact = ((AddressBook)entry.getValue()).contacts;
    ...
    public static void searchPersonCityState() {
        ...
        switch(choice) {
            case 1:	{
                for(AddressBook ad : addressbook_map.values()) {
